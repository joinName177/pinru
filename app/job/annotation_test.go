...
func TestAnnotationJobUsesRegisteredHandlerAndPersistsOutput(t *testing.T) {
	for _, kind := range []string{"annotation_export", "annotation_capture_table", "annotation_batch_capture_table", "annotation_pairwise_capture", "annotation_pairwise_materials", "annotation_pairwise_batch_review", "annotation_pairwise_export"} {
